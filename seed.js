...
db.Author.remove({}, function(err, authors) {
  ...
  db.Book.remove({}, function(err, books) {
    ...
    var mockingbird = new db.Book({
      title: "To Kill a Mockingbird",
      image: "https://s3-us-west-2.amazonaws.com/sandboxapi/to_kill_a_mockingbird.jpg",
      releaseDate: "July 11, 1960"
    })

    var harperLee =  new db.Author({
        name: "Harper Lee",
        alive: false
    })

    mockingbird.author = harperLee;
    mockingbird.save();
    harperLee.save();

    var gatsby = new db.Book({
...
function addBookAndAuthor(bookInfo, authorInfo){
  var book = new db.Book(bookInfo)

  var author = new db.Author(authorInfo)
